...
class DashboardController extends Controller
{
    public function index(Request $request)
    {
        ...
        // Untuk tab peringkat MIPA - tambahkan parameter search
        if ($tab === 'peringkat_mipa') {
            $hasilArasMipa = $aras->getPerhitunganLengkapPerJurusan('MIPA', $searchSiswa);
        }
        
        // Untuk tab peringkat IPS - tambahkan parameter search
        if ($tab === 'peringkat_ips') {
            $hasilArasIps = $aras->getPerhitunganLengkapPerJurusan('IPS', $searchSiswa);
        }
